...
const AppHeader = () => {
    return(
    <View 
    style={{ flex: 1, width:'auto', flexDirection:'row', marginLeft:-15, paddingLeft:0 }}>
    <Image style={{ width: 50, height: 50 }} source={require('./image/windows.png')} />
    ...
    source={require('./image/windows.png')} />
    </View>
    );
}
